...
- Vault-тексти інколи кажуть, що U7 «блокує» термінально — у коді U7 лише **маркує** blockers у `unresolved_gaps`; політика write vs U6 vs clarification живе в **U8** (`isWriteCompatibleCorpusGapBlocker`).
