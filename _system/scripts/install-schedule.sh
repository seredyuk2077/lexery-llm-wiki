...
echo ""
echo "Behavior: maintenance runs at login (RunAtLoad) and every day at ~09:10 while the Mac is awake (StartCalendarInterval). No cloud hosting."
echo "Optional hourly runs: edit the plist and add StartInterval (seconds) if you want denser sync."
